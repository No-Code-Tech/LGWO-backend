...
class EmployeeCycle(models.Model):
    employee = models.ForeignKey(User,related_name="cycles",on_delete=True)
    cycle = models.ForeignKey(Cycle,related_name="cycle",on_delete=True)


class EmplpoyeeLog(models.Model):
    employee = models.ForeignKey(User,related_name="logs",on_delete=True)
